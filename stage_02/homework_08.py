# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# СТИЛЬ КОДА. ДОМАШНЕЕ ЗАДАНИЕ
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# 1)	загрузить файл 03_code_style4.py;
# 2)	открыть файл редакторе среды разработки PyCharm;
# 3)	переименовать переменные, которые названы не в соответствии со стилем кода;
# 4)	добавить пробелы в коде в соответствии со стилем кода (подчеркиваются жел-тым);
# 5)	добавить отступы в коде в соответствии со стилем кода (подчеркиваются желтым).
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Программа :
# -*- coding: utf-8 -*-
